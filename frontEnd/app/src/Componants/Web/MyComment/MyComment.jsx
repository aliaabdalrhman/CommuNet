...
import { Card, CardContent, Typography, Avatar, Collapse } from '@mui/material';
                ...
                {posts == '' ? <>
                    <Box sx={{ mt: 14 }} className='font '>
                        <div className='font d-flex justify-content-center'>
                            <img src="/Images/comment.png" className='' height='400px' alt="" />
                        </div>
                        <div className='font d-flex justify-content-center'>
                            <Typography >OOPS! there is no comment ...</Typography>
                        </div>
                    </Box>
