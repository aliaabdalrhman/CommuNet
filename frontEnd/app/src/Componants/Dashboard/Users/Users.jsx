                    ...
                    <Typography className='font'>
                      <Box sx={{ display: 'flex', flexDirection: 'row' }} >
                        {!accordionData[index].isOpen ? (
                          <>
                            {user.image == null ? <Avatar  style={{ width: '40px', height: '40px' }} className='border' /> :
                              <Avatar src={user.image.secure_url}  style={{ width: '40px', height: '40px' }} className='border' />}
                    ...
                    <Box sx={{ mt: 1 }}>
                      <Box sx={{ flexDirection: 'row' }} className='d-flex justify-content-center gap-5 '>
                        <Box className='d-flex justify-content-center align-items-center ms-2 '>
                          {user.image == null ? <Avatar  className='border' style={{ width: '200px', height: '200px' }} /> : <Avatar src={user.image.secure_url} alt='' className='border' style={{ width: '200px', height: '200px' }} />}
                        </Box>
                      ...
                      <Box sx={{ display: 'flex', flexDirection: 'row', mt: 5, ml: 82 }}>
                        <Button variant="contained"
                          ...
                          size="small"
                          sx={{
                            backgroundColor: user.state_us ? 'red' : 'green',
                            color: '#fff',
                            '&:hover': {
                              backgroundColor: user.state_us ? 'darkred' : 'darkgreen',
                            },
                            mr: 2,
                          }}
                           > {user.state_us ? 'Disable Account' : 'Enable Account'}
                        </Button>
                        <Button variant="contained"
